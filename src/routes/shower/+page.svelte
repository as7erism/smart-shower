...
<div class="h-screen flex flex-col justify-between">
    <div class="flex m-4">
        <div class="flex-1">
            <svg onclick={goto("/settings")} version="1.0" xmlns="http://www.w3.org/2000/svg" width="34.0pt" height="35.0pt" viewBox="0 0 1280.000000 1278.000000" preserveAspectRatio="xMidYMid meet">
